...
#define EIFR  (*((char *)0x3c)  /** < External Interrupt Flag Register      */
#define EIMSK (*((char *)0x3d)) /** < External Interrupt Mask Register      */
...
#define EICRA (*((char *)0x69)) /** < External Interrupt Control Register A */
